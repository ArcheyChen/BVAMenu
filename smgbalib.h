//
// smgbalib v1.1 - a GBA API by Sebastian Mihai
//
// Versions:
//     1.1 - added PlotSinglePixelOpaque
//     1.0 - initial
//
// This is the main include file - aggregates all other smgbalib include files!
//
...
// Plots a SINGLE pixel, overwriting current pixel value
...
// Plot two pixels, overwriting current pixel value
// IMPORTANT: This function actually writes two pixels, due to how the GBA 
//            accesses video memory.
//            It has been superseded by PlotSinglePixelOpaque above, which
//            ACTUALLY plots a SINGLE pixel.
void PlotPixelOpaque(int x,int y, unsigned short int c);
// Plots two pixels, using first entry in the palette as the transparent colour
